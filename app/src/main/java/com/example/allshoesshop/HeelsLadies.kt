...
import com.example.allshoesshop.model.LadiesHeels
import com.example.allshoesshop.ui.theme.AllShoesShopTheme

class Heels : ComponentActivity() {
...
@Composable
fun HeelNavigation(modifier : Modifier = Modifier) {
...
@Composable
fun MyHeels(listme: Heels, modifier: Modifier) {
...
@Composable
fun HeelList(myitems:List<Heels>, modifier : Modifier = Modifier) {
...
@Composable
fun HeelsMainscreen(modifier: Modifier=Modifier){
    Column(modifier){
        Spacer(Modifier.padding(horizontal = 20.dp))
        HeelNavigation(modifier.fillMaxWidth())
        HeelList(myitems = LadiesHeels().loadladieshighheels()
        )
