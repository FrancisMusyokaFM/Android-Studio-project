...
@Composable
fun OpenNavigation(modifier : Modifier = Modifier) {
...
@Composable
fun ChildOpen(listme: ChildrenOpen, modifier: Modifier) {
...
@Composable
fun ChildList(myitems:List<ChildrenOpen>, modifier : Modifier = Modifier) {
...
@Composable
fun ChildMainscreen(modifier: Modifier=Modifier){
    Column(modifier){
        Spacer(Modifier.padding(horizontal = 20.dp))
        OpenNavigation(modifier.fillMaxWidth())
        ChildList(myitems = ChildrenOpenShoes().loadchildrenopenshoes()
        )
